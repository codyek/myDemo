...
public class OkexWebsocketClientEndpoint {
    ...
    public OkexWebsocketClientEndpoint(URI endpointURI) {
        try {
        	...
        	log.error(">> OkexWebsocketClientEndpoint init error ",e);
    ...
    public void onOpen(Session userSession) {
    	log.info(">> opening Okex websocket");
    ...
    public void onClose(Session userSession, CloseReason reason) {
    	...
    	log.error(">> closing Okex websocket" +" reason="+reason);
