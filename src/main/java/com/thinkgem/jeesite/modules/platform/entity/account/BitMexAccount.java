 ...
 * @version 2017-09-13
 */
public class BitMexAccount extends DataEntity<BitMexAccount> {
	...
	public BitMexAccount(String id){
		super(id);
	}
	...
	@Length(min=0, max=50, message="合约ID长度必须介于 0 和 50 之间")
	...
	@Length(min=0, max=50, message="合约类别长度必须介于 0 和 50 之间")
