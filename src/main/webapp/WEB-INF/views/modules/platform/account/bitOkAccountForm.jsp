...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/platform/account/bitOkAccount/">Ok账户信息表列表</a></li>
		<li class="active"><a href="${ctx}/platform/account/bitOkAccount/form?id=${bitOkAccount.id}">Ok账户信息表<shiro:hasPermission name="platform:account:bitOkAccount:edit">${not empty bitOkAccount.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="platform:account:bitOkAccount:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="bitOkAccount" action="${ctx}/platform/account/bitOkAccount/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="contractId" htmlEscape="false" maxlength="50" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="contractType" htmlEscape="false" maxlength="50" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="platform:account:bitOkAccount:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
